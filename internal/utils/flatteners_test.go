...
func TestFlattenTimeframeObject(t *testing.T) {
	testTimeframe := xmatters.DeviceTimeframe{
		...
		Days:              RandStringPointerList(2, 5),
	...
	tests := []struct {
		...
		},
		{
			...
			want: types.ObjectValueMust(
				...
				map[string]attr.Value{
					"name":                types.StringPointerValue(testTimeframe.Name),
					...
					"days": types.SetValueMust(
						types.StringType,
						[]attr.Value{
							types.StringPointerValue(testTimeframe.Days[0]),
							types.StringPointerValue(testTimeframe.Days[1]),
						},
					),
...
func TestFlattenDeviceObject(t *testing.T) {
	testDevice := xmatters.Device{
		...
		DeviceType:      RandStringPointer(5),
		EmailAddress:    RandStringPointer(5),
		ExternalKey:     RandStringPointer(5),
		ExternallyOwned: RandBoolPointer(),
		Name:            RandStringPointer(5),
		...
		PhoneNumber:       RandStringPointer(5),
		PIN:               RandStringPointer(5),
		PriorityThreshold: RandStringPointer(5),
		Sequence:          RandInt32Pointer(),
		Status:            RandStringPointer(5),
		TestStatus:        RandStringPointer(5),
					...
					"timeframes": types.SetValueMust(
						...
						[]attr.Value{
							types.ObjectValueMust(
								TimeframeObjectType.AttrTypes,
								map[string]attr.Value{
									"name":                types.StringPointerValue(testDevice.Timeframes[0].Name),
									...
									"days": types.SetValueMust(
										types.StringType,
										[]attr.Value{
											types.StringPointerValue(testDevice.Timeframes[0].Days[0]),
											types.StringPointerValue(testDevice.Timeframes[0].Days[1]),
										},
									),
			...
			want: types.ListValueMust(
				...
				[]attr.Value{
							...
							"timeframes": types.SetValueMust(
								...
								[]attr.Value{
									types.ObjectValueMust(
										TimeframeObjectType.AttrTypes,
										map[string]attr.Value{
											"name":                types.StringPointerValue(testDevices[0].Timeframes[0].Name),
											...
											"days": types.SetValueMust(
												types.StringType,
												[]attr.Value{
													types.StringPointerValue(testDevices[0].Timeframes[0].Days[0]),
													types.StringPointerValue(testDevices[0].Timeframes[0].Days[1]),
												},
											),
					...
					types.ObjectValueMust(
						DeviceObjectType.AttrTypes,
						map[string]attr.Value{
							"id":                 types.StringPointerValue(testDevices[1].ID),
							"target_name":        types.StringPointerValue(testDevices[1].TargetName),
							"country":            types.StringPointerValue(testDevices[1].Country),
							"default_device":     types.BoolPointerValue(testDevices[1].DefaultDevice),
							"delay":              types.Int32PointerValue(testDevices[1].Delay),
							"device_type":        types.StringPointerValue(testDevices[1].DeviceType),
							"email_address":      types.StringPointerValue(testDevices[1].EmailAddress),
							"external_key":       types.StringPointerValue(testDevices[1].ExternalKey),
							"externally_owned":   types.BoolPointerValue(testDevices[1].ExternallyOwned),
							"name":               types.StringPointerValue(testDevices[1].Name),
							"owner":              types.StringPointerValue(testDevices[1].Owner.ID),
							"phone_number":       types.StringPointerValue(testDevices[1].PhoneNumber),
							"pin":                types.StringPointerValue(testDevices[1].PIN),
							"priority_threshold": types.StringPointerValue(testDevices[1].PriorityThreshold),
							"sequence":           types.Int32PointerValue(testDevices[1].Sequence),
							"status":             types.StringPointerValue(testDevices[1].Status),
							"test_status":        types.StringPointerValue(testDevices[1].TestStatus),
							"two_way_device":     types.BoolPointerValue(testDevices[1].TwoWayDevice),
							"timeframes": types.SetValueMust(
								TimeframeObjectType,
								[]attr.Value{
									types.ObjectValueMust(
										TimeframeObjectType.AttrTypes,
										map[string]attr.Value{
											"name":                types.StringPointerValue(testDevices[1].Timeframes[0].Name),
											"start_time":          types.StringPointerValue(testDevices[1].Timeframes[0].StartTime),
											"duration_in_minutes": types.Int32PointerValue(testDevices[1].Timeframes[0].DurationInMinutes),
											"days": types.SetValueMust(
												types.StringType,
												[]attr.Value{
													types.StringPointerValue(testDevices[1].Timeframes[0].Days[0]),
													types.StringPointerValue(testDevices[1].Timeframes[0].Days[1]),
												},
											),
											"exclude_holidays": types.BoolPointerValue(testDevices[1].Timeframes[0].ExcludeHolidays),
										},
									),
								},
							),
			...
			want: types.SetValueMust(
				...
				[]attr.Value{
					types.ObjectValueMust(
						TimeframeObjectType.AttrTypes,
						map[string]attr.Value{
							"name":                types.StringPointerValue(testTimeframes[0].Name),
							...
							"days": types.SetValueMust(
								types.StringType,
								[]attr.Value{
									types.StringPointerValue(testTimeframes[0].Days[0]),
									types.StringPointerValue(testTimeframes[0].Days[1]),
								},
							),
					...
					types.ObjectValueMust(
						TimeframeObjectType.AttrTypes,
						map[string]attr.Value{
							"name":                types.StringPointerValue(testTimeframes[1].Name),
							...
							"days": types.SetValueMust(
								types.StringType,
								[]attr.Value{
									types.StringPointerValue(testTimeframes[1].Days[0]),
									types.StringPointerValue(testTimeframes[1].Days[1]),
								},
							),
